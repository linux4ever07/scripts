...
declare of_bname of_dn info_dn of of_tmp of_remux
...
# options.
	if_info_f="${info_dn}/${bname}_info.txt"
	of_info_f="${info_dn}/${of_bname}_info.txt"
	of_remux_info_f="${info_dn}/${of_remux_bname}_info.txt"
	hb_version_info_f="${info_dn}/${cmd[0]}_version.txt"
	hb_opts_info_f="${info_dn}/${cmd[0]}_options.txt"
	ff_version_info_f="${info_dn}/${cmd[1]}_version.txt"
	ff_opts_info_f="${info_dn}/${cmd[1]}_options.txt"
	size_info_f="${info_dn}/size.txt"
	mediainfo_info_f="${info_dn}/${bname}_mediainfo.txt"
