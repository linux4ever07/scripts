...
# options.
	if_info_f="${of_dn_info}/${bname}_info.txt"
	of_info_f="${of_dn_info}/${of_bname}_info.txt"
	of_remux_info_f="${of_dn_info}/${of_remux_bname}_info.txt"
	hb_version_info_f="${of_dn_info}/${cmd[0]}_version.txt"
	hb_opts_info_f="${of_dn_info}/${cmd[0]}_options.txt"
	ff_version_info_f="${of_dn_info}/${cmd[1]}_version.txt"
	ff_opts_info_f="${of_dn_info}/${cmd[1]}_options.txt"
	size_info_f="${of_dn_info}/size.txt"
